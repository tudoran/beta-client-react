...
const tooltipAmount =
  <Tooltip id='tooltipAmount' className='tooltip-primary'>
    Estimate how much you would need for your Education goal.
  </Tooltip>
...
const education = ({ amount, duration, initialDeposit }) => {
  return (
    <div className='form-group'>
      <div className={classes['form-paragraph']}>
        ...
        to pay for my Education goal. I may need this money in
        <OverlayTrigger trigger='focus' placement='bottom'
